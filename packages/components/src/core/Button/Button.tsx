...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const styleVars: React.CSSProperties = {
      ...
      ['--button-hover-color' as string]: variantTokens.hover.color || variantTokens.color,
      ...
      ['--button-active-color' as string]: variantTokens.active.color || variantTokens.color,
