...
- **Core Components** – Buttons, inputs, selects, textareas, modals, cards, tabs, table, toast notifications, alerts, navigation (top bar & sidebar), checkbox, radio group, toggle, date input, file upload, avatar, badge, spinner, progress bar and data visualization components (AreaChart, BarChart, LineChart, PieChart).  All components accept sensible props and expose accessible attributes.
